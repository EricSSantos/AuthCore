...
namespace AuthCore.Domain.Aggregates.Sessions.Interfaces
{
    ...
    public interface ISessionService
    {
        ...
        Task<SessionCreationResult> CreateSessionAsync(Guid userId, string sessionId, string rawSession, DeviceInfo deviceInfo, TimeSpan ttl, TimeSpan maxLifetime, DateTime utcNow);
